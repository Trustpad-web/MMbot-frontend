    ...
    return (
        <>
            <div className='mb-[30px]'>
                ...
                <p className='font-poppins-light text-[16px] text-[#CBD6E4]'>Configure the buy setting of your Ace bot.</p>
            </div>
            <div className='bg-[#212F40] h-[100%] min-h-[710px] 320-529:min-h-[auto] 530-1100:min-h-[auto] flex flex-col gap-[20px] w-full rounded-[10px] px-[30px] py-[30px]'>
                <div>
                    ...
                    <div className='border border-[#34475F] bg-[#1A2531] rounded-[10px] px-[10px] py-[8px]'>
                        <input type='text' placeholder='1000' className='text-white text-[14px] font-poppins-regular w-full px-[5px] border-none bg-[transparent] outline-none' />
                    </div>
                </div>
                <div>
